...
Guide for creating, updating, and reviewing UML model elements and diagrams in Astah Pro via MCP.

## Understanding UML

```
NO UML MODELING WITHOUT UNDERSTANDING WHAT UML IS AND WHY IT MATTERS FIRST
```
...
<HARD-GATE>
Do NOT skip this step because you "already know what UML is."
</HARD-GATE>

## Understanding Agile Modeling

```
NO UML MODELLING WITHOUT UNDERSTANDING AGILE MODELING
```
...
- Presenting diagrams to the user in the terminal
- Enabling subagent reviewers to visually inspect diagrams
- Creating a visual record of the design
