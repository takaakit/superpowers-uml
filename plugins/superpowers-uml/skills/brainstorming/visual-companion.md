...
Browser-based visual brainstorming companion for showing mockups and options.
...
- **Side-by-side visual comparisons** — comparing two layouts, two color schemes, two UI design directions
- **UI design polish** — when the question is about look and feel, spacing, visual hierarchy
...
**Do not use Visual Companion for software design** — Use Visual Companion strictly for prototyping. For component design, architecture design, and any other descriptions or examinations of functionality, structures, or behaviors that MUST be considered using UML models and diagrams. (See the UML Modeling Guide for more details.)
